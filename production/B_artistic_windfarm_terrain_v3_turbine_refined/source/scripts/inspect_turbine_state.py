#!/usr/bin/env python3
"""Validate V3 turbine hierarchy, local rotor axes and sampled clearances."""
...
EXPECTED_RADIUS = float(SPEC["dimensions"]["turbine_rotor_radius_m"])
...
def main() -> None:
    ...
    for index in range(1, 4):
        ...
        turbine_pass = hierarchy_ok and axis_ok and rpm_ok and radius_error <= .025 and clearance_min >= .55
    ...
    report = {
        ...
        "thresholds": {"radius_error_max_m": .025, "minimum_tip_clearance_m": .55, "rpm_min": 0.01},
        "turbines": turbines,
        "pass": pass_all,
    }
