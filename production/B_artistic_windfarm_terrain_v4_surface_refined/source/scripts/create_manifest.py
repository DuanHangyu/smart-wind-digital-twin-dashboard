...
def main() -> None:
    ...
    manifest = {
        "asset": json.loads((ROOT / "source/terrain_spec.json").read_text(encoding="utf-8"))["asset"],
        "version": json.loads((ROOT / "source/terrain_spec.json").read_text(encoding="utf-8"))["version"],
        "files": files,
