...
RAW="$ROOT/export/C_dismantlable_turbine_v2_low_raw.glb"
QUANTIZED="$ROOT/export/C_dismantlable_turbine_v2_low_quantized.glb"
NORMAL="$ROOT/export/C_dismantlable_turbine_v2_low_normal_uastc.glb"
UASTC="$ROOT/export/C_dismantlable_turbine_v2_low_uastc.glb"
FINAL="$ROOT/export/C_dismantlable_turbine_v2_low_ktx2.glb"
...
cp "$FINAL" "$ROOT/web/public/models/C_dismantlable_turbine_v2_low_ktx2.glb"
